    ...
    if (error || !livro) {
        return (
            <View className="flex-1  bg-surface justify-center items-center px-6">
                <Text className="text-red-400 font-bold text-xl mb-4">Livro não encontrado</Text>
    ...
    return (
        <View className="flex-1 bg-surface pt-16">
            ...
            <View className="px-6 flex-row items-center justify-between mb-6">
                <TouchableOpacity onPress={() => router.back()} className="p-2 -ml-2 *:bg-slate-800 rounded-xl flex-row items-center gap-2">
            ...
            >
                <View className="flex-1 px-6 pt-2" style={{ paddingBottom: insets.bottom }}>
                    ...
                    <View className="flex-row justify-between items-center mb-6">
                        ...
                        <Text className="text-primary font-bold">aaaaaaa</Text>
                    </View>

                    {/* Adicionar rápido */}
                    <TouchableOpacity
                        activeOpacity={0.8}
                        onPress={() => router.push({pathname: '/create-card', params: { livroId: id } })}
